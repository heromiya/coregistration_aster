...
export INIMG=../20170703_041651_HODO1_L1B_002297_1.tiff
...
export OUTPUT=../20170703_041651_HODO1_L1B_002297_1_shifted.tiff
...
OBSY=$(echo $INIMG | sed 's/.*\/\([0-9]\{4\}\)\([0-9]\{2\}\)\([0-9]\{2\}\)_.*_.*_.*_[0-9]*_1.tiff/\1/')
OBSM=$(echo $INIMG | sed 's/.*\/\([0-9]\{4\}\)\([0-9]\{2\}\)\([0-9]\{2\}\)_.*_.*_.*_[0-9]*_1.tiff/\2/')
OBSD=$(echo $INIMG | sed 's/.*\/\([0-9]\{4\}\)\([0-9]\{2\}\)\([0-9]\{2\}\)_.*_.*_.*_[0-9]*_1.tiff/\3/')
